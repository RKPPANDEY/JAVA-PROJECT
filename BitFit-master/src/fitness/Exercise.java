...
public class Exercise extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			int BodyBuildingTime = Math.abs(Integer.parseInt(request.getParameter("Body Building")));
			
			int GymnasticsTime = Math.abs(Integer.parseInt(request.getParameter("Gymnastics")));
			...
			statement.executeUpdate("Update exercise set time="+BodyBuildingTime+" where ename='Body Building'");
			statement.executeUpdate("Update exercise set time="+GymnasticsTime+" where ename='Gymnastics'");
