...
<%  try{
	...
	Connection connection = DriverManager.getConnection(
            "jdbc:mysql://localhost:3306/food", "root", "faiz");
	...
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
			...
			do{
				...
				if(rs.getString(2).equals("Gymnastics")){
					ecount = ecount + Integer.parseInt(rs.getString(3))*20;
				}
				if(rs.getString(2).equals("Body Building")){
					ecount = ecount + Integer.parseInt(rs.getString(3))*24;
				}
			}while(rs.next());
